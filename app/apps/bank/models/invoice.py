...
class Invoice(Base):
    ...
    curr_count = Column(Numeric(scale=10, precision=2), nullable=False, default=0)
    status = Column(Enum(Statuses, create_constraint=True, name='statuses'), nullable=False, default=Statuses.progress)
